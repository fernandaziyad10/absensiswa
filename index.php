...
if(isset($_POST["btn"])) {
  ...
  if ($dataAwal) {
    echo "<h3 style = 'color : red ;'>Dilarang menduplikat data!!</h3>";
  } else {
    $_SESSION["data_siswa"][] = [
      "nama" => $nama,
      "nis" => $nis,
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <table class="table table-striped">
            ...
            <td>
                <button class="btn btn-warning"><a href="hapus.php?id=<?= $key ;?>">Hapus</a></button>
                <button class="btn btn-danger"><a href="detail.php?id=<?= $key ;?>">Detail</a></button>
                <button class="btn btn-dark"><a href="edit.php?id=<?= $key ;?>">Edit</a></button>
            </td>
    </tr>
     <?php endforeach;?>
     <?php endif;?>
